...
The local timeline consists of public listed posts and replies that our members make. To help fulfil our intention of prioritizing FOSS discussion, you should make use of the labeling tools that Mastodon provides for improved reach and individual curation. Hashtags and content warnings (CWs) help people customize their timelines. By using these tools, you make it possible for others to shape their experiences by allowing them to filter or hide content they don't want.

You must give special care for labeling topics that others are likely to find stressful. This includes, but is not limited to:
